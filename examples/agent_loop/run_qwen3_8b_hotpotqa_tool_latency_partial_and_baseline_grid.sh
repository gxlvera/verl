...
export ONLINE_SEARCH_RETRIEVAL_URL=${ONLINE_SEARCH_RETRIEVAL_URL:-${ONLINE_SEARCH_URL:-http://127.0.0.1:8000/retrieve}}
export ONLINE_SEARCH_TOPK=${ONLINE_SEARCH_TOPK:-3}
export ONLINE_SEARCH_TIMEOUT=${ONLINE_SEARCH_TIMEOUT:-20}
export ONLINE_SEARCH_MAX_CHARS=${ONLINE_SEARCH_MAX_CHARS:-${MAX_TOOL_RESPONSE_LENGTH:-12000}}
