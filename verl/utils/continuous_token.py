...
class QwenVLContinuousTokenBuilder(QwenContinuousTokenBuilder):
    ...
    def build_initial_tokens(
        ...
        *,
        ...
        token_ids, mm_extras = self.render_tokens_with_mm(messages, images, add_generation_prompt=True, tools=tools)
    ...
    def merge_tokens(
        ...
        *,
        ...
        merge_result = self._merge_non_assistant_token_ids(runtime_token_ids, appended_token_ids)
    ...
    def _slice_mm_delta(self, prev_image_count: int, full_mm_extras: dict[str, Any]) -> dict[str, Any]:
        ...
        if not grid_thw and pixel_values is not None:
            ...
            logger.warning(
                ...
                "passing full pixel_values (prev_image_count=%d)",
                prev_image_count,
            )
            return {
